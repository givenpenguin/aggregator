...
function getClothes() {
    var clothes = [
        ...
        {clothId: "0",
        img: {
            pics: ["picsA-V/LuxePunk.jpg",
            "picsA-V/LuxePunk_Pre.jpg"],
            alt: "Hoodie&#47;LuxePunk"
        },
        title: "LuxePunk",
        price: "6500",
        ...
        {clothId: "1",
        img: {
            pics: ["picsA-V/GrungeSafari.jpg",
            "picsA-V/GrungeSafari_Pre.jpg",
            "picsA-V/GrungeSafari_Pic1.jpg",
            "picsA-V/GrungeSafari_Pic2.jpg"],
            alt: "Hoodie&#47;GrungeSafari"
        },
        title: "GrungeSafari",
        price: "6500",
        brend: "Automatic Vertical",
        description: `Футтер 3&#215; нитка петля 370 гр/м 2<br>
        ...
        {clothId: "2",
        img: {
            pics: ["picsA-V/PresionVision.png",
            "picsA-V/PresionVision_Pre.jpg",
            "picsA-V/PresionVision_Pic1.jpeg"],
        ...
        {clothId: "3",
        img: {
            pics: ["picsA-V/SpaceOdyssey.jpg",
            "picsA-V/SpaceOdyssey_Pre.jpg",
            "picsA-V/SpaceOdyssey_Pic1.jpg"],
...
function menuBrend(brends) {
    ...
    menuEl.innerHTML += `<a href="/coursework/AggregatorWebsite/main.html" class="dropdown__link">Все бренды &#11119;</a>`
